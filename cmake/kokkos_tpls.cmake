...
if(KOKKOS_ENABLE_CUDA_TILE)
  if(NOT KOKKOS_ENABLE_CUDA)
    message(FATAL_ERROR "Kokkos_ENABLE_CUDA_TILE requires Kokkos_ENABLE_CUDA=ON")
  endif()
  if(CUDAToolkit_VERSION VERSION_LESS 13.3)
    message(FATAL_ERROR "Kokkos_ENABLE_CUDA_TILE requires CUDA Toolkit 13.3 or newer (found ${CUDAToolkit_VERSION})")
  endif()
endif()
